...
if ( !class_exists( 'Classic_CLC_Component_CTA_Banner' ) ) {
	 ...
	 * @since 1.0.0
	 */
	class Classic_CLC_Component_CTA_Banner extends CLC_Component_Content_Block {
		 ...
		 * @since 1.0.0
		 */
		public $type = 'classic-cta-banner';
		...
		public function render_layout() {
			...
			<div id="<?php echo esc_attr( $this->selector_id ); ?>" class="clc-wrapper clc-cta-banner">				
				<?php if ( $this->image ) { ?>
